...
//mod by xiaofeng
static  int16_t kOverHangMax1VAG[3] = { 6, 3, 2 };
static  int16_t kOverHangMax2VAG[3] = { 9, 5, 3 };
static  int16_t kLocalThresholdVAG[3] = { 94, 94, 94 };
static  int16_t kGlobalThresholdVAG[3] = { 1100, 1050, 1100 };
//end mod

//xiaofeng add for adjust the sensitivity
void setMode3Params(const int16_t params[4][3])
{
	int i = 0;
	for (i = 0; i < 3; i++)
	{
		kOverHangMax1VAG[i] = params[0][i];
	}
	for (i = 0; i < 3; i++)
	{
		kOverHangMax2VAG[i] = params[1][i];
	}
	for (i = 0; i < 3; i++)
	{
		kLocalThresholdVAG[i] = params[2][i];
	}
	for (i = 0; i < 3; i++)
	{
		kGlobalThresholdVAG[i] = params[3][i];
	}
}
//end xiaofeng add
